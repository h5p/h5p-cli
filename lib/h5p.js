    ...
    readJSONFiles(fileNames, function (files) {
      ...
      translation.semantics = updateTranslationFields(files.semantics.content, translation.semantics, function (field, attr, source, target) {
        if (attr === 'label' || attr === 'description' || attr === 'entity' || (attr === 'default' && field.type === 'text')) {
          ...
          target[attr] = (source !== undefined && source !== null && source[attr] !== undefined ? source[attr] : 'TODO');
          return true;
        }
      });
...
var updateTranslationField = function (field, oldTranslation, handler) {
  ...
  for (var attr in field) {
    if (attr === 'field') {
      ...
      updatedTranslation.field = updateTranslationField(field.field, oldTranslation !== undefined && oldTranslation !== null ? oldTranslation.field : undefined, handler);
      ...
      updatedTranslation[attr] = updateTranslationFields(field[attr], oldTranslation !== undefined && oldTranslation !== null ? oldTranslation[attr] : undefined, handler);
