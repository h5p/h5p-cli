...
//      if (self.mainLibrary.displayUsingIframe()) {
  ...
  /*    }
      ...
      h5pContainer +
      '</div>' +
      '<div class="h5p-dev-editor-wrapper"><div class="h5p-dev-editor-inner-wrapper"><div class="h5p-dev-editor-buttons"><button class="cancel">Cancel</button><button class="save">Save</button></div><div class="h5p-dev-editor"></div></div></div>' +
      '</body>' +
      '</html>';
