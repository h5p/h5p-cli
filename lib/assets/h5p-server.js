...
(function($) {
  $(document).ready(function () {
    ...
    $('.h5p-dev-edit').click(function () {
      $('.h5p-dev-editor-wrapper').show().addClass('h5p-dev-d-flex');
